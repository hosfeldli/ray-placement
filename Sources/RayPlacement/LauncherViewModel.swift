...
final class LauncherViewModel: ObservableObject {
    ...
    private func builtInItems() -> [LauncherItem] {
        var items: [LauncherItem] = [
            ...
            LauncherItem(id: "builtin.notes", title: "LiamFlow Notes", subtitle: "Open the separate Markdown notes window", icon: .system("note.text"), keywords: ["notes", "markdown", "write"], action: .system(.openNotes), shortcut: SettingsStore.shared.notesHotkeyEnabled ? ShortcutSpec(string: SettingsStore.shared.notesShortcut)?.displayString : nil),
            ...
            LauncherItem(id: "builtin.settings", title: "LiamFlow Settings", subtitle: "Hotkeys, performance, privacy, and extensions", icon: .system("gearshape.fill"), keywords: ["preferences", "hotkey", "shortcut", "performance", "accessibility"], action: .system(.openSettings), shortcut: "⌘,"),
            LauncherItem(id: "builtin.quit", title: "Quit LiamFlow", subtitle: "System", icon: .system("power"), keywords: ["exit"], action: .system(.quit), shortcut: "⌘Q")
        ]
